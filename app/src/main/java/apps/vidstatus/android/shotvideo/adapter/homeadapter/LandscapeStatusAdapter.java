...
public class LandscapeStatusAdapter extends RecyclerView.Adapter<LandscapeStatusAdapter.VideoViewHolder> {

    ArrayList<ItemsItem> landscapeItems;
    Activity activity;

    public LandscapeStatusAdapter(ArrayList<ItemsItem> landscapeItems, Activity activity) {
    ...
    public void onBindViewHolder(@NonNull VideoViewHolder holder, int position) {
        ...
        holder.landscapeBinding.getRoot().setOnClickListener(v -> {
